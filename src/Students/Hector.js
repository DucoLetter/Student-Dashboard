...
const getDifficultyHector = () => alleDifficulty[3].splice(0, 1); //De 3 staat voor Hector
const getEnjoymentHector = () => alleEnjoyment[3].splice(0, 1);
let assignmentRatingAverage = Assigments;

assignmentRatingAverage = assignmentRatingAverage.map((avg) => ({
  assignment: avg.assignment,
  difficultyRating: getDifficultyHector()[0],
  enjoymentRating: getEnjoymentHector()[0],
}));
          ...
          <table className="tableInformationStudents">
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                  <td>Email</td>
                  <td>Hector.Dixon@example.com</td>
                </tr>
                <tr>
                  <td>Phone number</td>
                  <td>(118)-332-5559</td>
