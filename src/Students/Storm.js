...
const getDifficultyWietske = () => alleDifficulty[8].splice(0, 1); //De 8 staat voor Wietske
const getEnjoymentWietske = () => alleEnjoyment[8].splice(0, 1);
...
assignmentRatingAverage = assignmentRatingAverage.map((avg) => ({
  ...
  enjoymentRating: getEnjoymentWietske()[0],
}));
          ...
          <table className="tableInformationStudents">
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                  <td>Email</td>
                  <td>storm.bryant@example.com</td>
                </tr>
                <tr>
                  <td>Phone number</td>
                  <td>(366)-410-2819</td>
