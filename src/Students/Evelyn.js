...
const getDifficultyEvelyn = () => alleDifficulty[0].splice(0, 1); //De 0 staat voor Evelyn
const getEnjoymentEvelyn = () => alleEnjoyment[0].splice(0, 1);
let assignmentRatingAverage = Assigments;

assignmentRatingAverage = assignmentRatingAverage.map((avg) => ({
  assignment: avg.assignment,
  difficultyRating: getDifficultyEvelyn()[0],
  enjoymentRating: getEnjoymentEvelyn()[0],
}));
...
class Evelyn extends Component {
  constructor() {
    super();
    this.state = {
      difficulty: {
          ...
          <table className="tableInformationStudents">
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                  <td>Email</td>
                  <td>evelyn.castro@example.com</td>
                </tr>
                <tr>
                  <td>Phone number</td>
                  <td>(904)-761-2788</td>
