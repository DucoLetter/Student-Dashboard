...
const getDifficultyStorm = () => alleDifficulty[9].splice(0, 1); //De 9 staat voor Storm
const getEnjoymentStorm = () => alleEnjoyment[9].splice(0, 1);
let assignmentRatingAverage = Assigments;

assignmentRatingAverage = assignmentRatingAverage.map((avg) => ({
  assignment: avg.assignment,
  difficultyRating: getDifficultyStorm()[0],
  enjoymentRating: getEnjoymentStorm()[0],
}));
          ...
          <table className="tableInformationStudents">
            ...
            <tbody>
              <tbody>
                <tr>
                  <td>Name</td>
                  <td>Wietske Janssen</td>
                </tr>
                <tr>
                  <td>Email</td>
                  <td>wietske.jansson@example.com</td>
                </tr>
                <tr>
                  <td>Phone number</td>
                  <td>(889)-016-5083</td>
