...
const getDifficultyFloris = () => alleDifficulty[2].splice(0, 1); //De 2 staat voor Floris
const getEnjoymentFloris = () => alleEnjoyment[2].splice(0, 1);
let assignmentRatingAverage = Assigments;

assignmentRatingAverage = assignmentRatingAverage.map((avg) => ({
  assignment: avg.assignment,
  difficultyRating: getDifficultyFloris()[0],
  enjoymentRating: getEnjoymentFloris()[0],
}));
...
class Floris extends Component {
  constructor() {
    super();
    this.state = {
      difficulty: {
          ...
          <table className="tableInformationStudents">
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                  <td>Email</td>
                  <td>floris.rogers@example.com</td>
                </tr>
                <tr>
                  <td>Phone number</td>
                  <td>(935)-907-1034</td>
