...
const getDifficultyAranka = () => alleDifficulty[1].splice(0, 1); //De 1 staat voor Aranka
const getEnjoymentAranka = () => alleEnjoyment[1].splice(0, 1);
let assignmentRatingAverage = Assigments;

assignmentRatingAverage = assignmentRatingAverage.map((avg) => ({
  assignment: avg.assignment,
  difficultyRating: getDifficultyAranka()[0],
  enjoymentRating: getEnjoymentAranka()[0],
}));
...
class Aranka extends Component {
  constructor() {
    super();
    this.state = {
      difficulty: {
          ...
          <table className="tableInformationStudents">
            ...
            <tbody>
              <tbody>
                <tr>
                  <td>Name</td>
                  <td>Aranka Carlson</td>
                </tr>
                <tr>
                  <td>Email</td>
                  <td>acarlson0@hud.gov</td>
                </tr>
                <tr>
                  <td>Phone number</td>
                  <td>+86 282 458 2057</td>
                </tr>
                <tr>
                  <td>Leeftijd</td>
                  <td>26</td>
